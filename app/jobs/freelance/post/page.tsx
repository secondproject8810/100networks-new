    ...
    <div className="w-[65%] mx-auto py-6">
      <div className="flex items-center mb-8">
        <Link href="/jobs/freelance" className="mr-6">
          <Button 
            variant="ghost"
            className="flex items-center text-slate-600 hover:text-primary-navy hover:bg-slate-50 rounded-xl p-3"
          >
      ...
      <Card className="border-slate-200 shadow-sm">
        ...
        <CardContent>
          <form className="space-y-8">
            ...
            <div className="space-y-3">
              <Label htmlFor="requirements" className="text-sm font-subheading font-medium text-primary-navy">Requirements</Label>
              <Textarea
                id="requirements"
                ...
                className="border-slate-200 focus:border-primary-navy rounded-xl font-subheading resize-none"
              />
              <p className="text-sm text-slate-500 font-subheading">List each requirement on a new line starting with •</p>
            </div>

            <div className="space-y-3">
              <Label htmlFor="responsibilities" className="text-sm font-subheading font-medium text-primary-navy">Responsibilities</Label>
              <Textarea
                id="responsibilities"
                ...
                className="border-slate-200 focus:border-primary-navy rounded-xl font-subheading resize-none"
              />
              <p className="text-sm text-slate-500 font-subheading">List each responsibility on a new line starting with •</p>
            </div>
